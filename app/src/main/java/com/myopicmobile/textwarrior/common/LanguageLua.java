...
public class LanguageLua extends Language {
	...
	private final static String keywordTarget ="and|asm|break|case|catch|command|const|continue|default|do|else|elseif|end|enum|false|finally|for|function|goto|global|if|in|is|keyword|lambda|local|nil|not|operator|or|repeat|return|switch|take|then|true|try|until|when|while|with";
	...
	private final static String packageName="coroutine|debug|io|luajava|math|os|package|string|table|utf8|bool|userdata|vm|translator|smgr|libc";
	...
	private final static String package_table = "add|clear|clone|concat|create|const|find|fill|foreach|foreachi|gfind|insert|maxn|move|pack|remove|size|sort|unpack|vals";
	private final static String package_utf8 = "byte|char|charpattern|charpos|codepoint|codes|escape|find|fold|graphemes|gfind|gmatch|gsub|insert|len|lower|match|ncasecmp|next|offset|remove|reverse|sub|title|upper|width|widthindex";
	...
	private final static String package_bool = "tostring|tonumber|not|not|or|xor|eq|is|toexpr";
    private final static String package_userdata = "isuserdata|islight|type|equals|tostring|address|fromany";
    private final static String package_vm = "execute|concat|objlen|equal|lt|le|tonumber|tointeger|gcinfo|gettop|memory|gcstep|gccollect|newthread|status|resume|yield|currentthread|typename|getci|getstack|gcstop|gcstart|gcsetpause|gcsetstepmul|gcinc|getregistry|getglobalenv|setglobalenv|isfunction|isnil|isboolean|isnumber|isstring|istable|isuserdata|isthread|iscfunction|rawget|rawset|rawlen|createtable|newuserdata|getmetatable|setmetatable|error|assert|traceback";
    private final static String package_translator = "paser|get";
    private final static String package_smgr = "getuserid|hasshareduserid|getdatadir|readfile|writefile|deletefile|listfiles|fileexists|getfilesize|copyfile|renamefile|getpackagename|mkdir|find";
    private final static String package_libc = "malloc|calloc|realloc|free|memset|memcpy|memmove|memcmp|strlen|strcpy|strncpy|strcat|strncat|strcmp|strncmp|strchr|strrchr|strstr|strtok|atoi|atol|atof|strtol|strtoul|strtod|printf|sprintf|sscanf|scanf|getchar|putchar|fopen|fclose|fread|fwrite|fseek|ftell|rewind|time|gmtime|localtime|mktime|asctime|strftime|signal|kill|raise|getpid|fork|execve|wait|waitpid|exit|perror|strerror|errno    ";
	...
	private LanguageLua(){
		...
		super.addBasePackage("bool",package_bool.split("\\|"));
    	super.addBasePackage("userdata",package_userdata.split("\\|"));
    	super.addBasePackage("vm",package_vm.split("\\|"));
    	super.addBasePackage("translator",package_translator.split("\\|"));
    	super.addBasePackage("smgr",package_smgr.split("\\|"));
    	super.addBasePackage("libc",package_libc.split("\\|"));
	...
	public void setHighlightHexColorsEnabled(boolean enabled) {
